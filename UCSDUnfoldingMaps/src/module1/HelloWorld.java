...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		//this.background(255, 204, 100);
		this.noStroke();
		
		colorMode(RGB);
		for (int i = 0; i < 800; i++) {
			  for (int j = 0; j < 800; j++) {
			    //stroke(i,205, 204, 100);
				  stroke(i,150,200,50);
			    point(i, j);
			  }
			}
		...
		map1 = new UnfoldingMap(this, provider);//this will result in map1 taking up the whole 800*600 applet window
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, provider);
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
		//偏台南22.9726799,120.051929//偏高雄22.6257233,120.2801165
	    //map2.zoomAndPanTo(zoomLevel, new Location(22.6257233f,120.2801165f));
	    //map2.zoomAndPanTo(zoomLevel, new Location(-22.9, -43.2));//Rio de Janeiro, Brazil
